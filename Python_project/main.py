...
def Send():
  ...
  def sender():
    ...
    print("Date has beem transmitted succesfully ")



  #icon
  image_icon1=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/send.png")
  window.iconphoto(False,image_icon1)

  Sbackground=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/sender.png")
  Label(window,image=Sbackground).place(x=-2,y=0)

  Mbackground=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/id.png")
...
def Receive():
  ...
  #icon
  image_icon1=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/receive.png")
  main.iconphoto(False,image_icon1) 

  Hbackground=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/receiver.png")
  Label(main,image=Hbackground).place(x=-2,y=0)

  logo=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/profile.png")
  ...
  imageicon=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/arrow.png")
...
#icon
image_icon=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/icon.png")
...
send_image=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/send.png")
send=Button(root,image=send_image,bg="#f4fdfe",bd=0,command=Send)
send.place(x=50,y=100)


receive_image=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/receive.png")
...
background=PhotoImage(file="D:/STUDY_MATERIALS/S6/PYTHON/background.png")
